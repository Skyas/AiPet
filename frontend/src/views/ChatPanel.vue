  ...
  <div class="chat-panel">
    ...
    <div class="titlebar" style="-webkit-app-region: drag">
      ...
      <div class="titlebar-actions" style="-webkit-app-region: no-drag">
        <button class="icon-btn" title="清空对话" @click="clearChat">🗑</button>
...
.pet-name { font-size: 14px; font-weight: 500; color: #c9b8f8; }
...
.user .bubble { background: rgba(139, 92, 246, 0.3); border: 1px solid rgba(139,92,246,0.2); }
.assistant .bubble { background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.06); }
...
textarea {
  ...
  border-radius: 10px; color: #e8e8ec; font-size: 13px; padding: 8px 10px;
...
.send-btn {
  ...
  background: rgba(139,92,246,0.6); color: white; font-size: 15px;
